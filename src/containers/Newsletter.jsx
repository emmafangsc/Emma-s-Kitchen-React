            ...
            <form action="newsletter.php" method="post" >
                <div className="newsletter-container px-8 lg:px-0">
                    ...
                    <div className="input-container flex flex-col gap-[1rem] md:flex-row justify-between pt-[2rem] text-[#f0f0f0] font-OrkneyRegular">
                        <input type="text" placeholder="First name" name="first-name" required className="shadow-md w-full sm:w-[18rem] bg-[#000000] opacity-30 pl-[1rem] py-[4px]" />
                        <input type="text" placeholder="Last name" name="last-name" required className="shadow-md w-full sm:w-[18rem] bg-[#000000] opacity-30 pl-[1rem] py-[4px]" />
