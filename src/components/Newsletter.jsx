                ...
                <div className="newsletter-container px-8 md:px-16 xl:px-0">
                    ...
                    <div className="input-container">
                        <form  method="post" className='flex flex-col gap-[1rem] lg:flex-row justify-between pt-[2rem] text-[#f0f0f0] font-OrkneyRegular'>
                            <input type="text" placeholder={t('language.newsletter-firstName')} name="firstName" required className="shadow-md w-full sm:w-[16rem] bg-[#000000] opacity-30 pl-[1rem] py-[4px]" onChange={(e)=>setFirstName(e.target.value)}/>
                            <input type="text" placeholder={t('language.newsletter-lastName')} name="lastName" required className="shadow-md w-full sm:w-[16rem] bg-[#000000] opacity-30 pl-[1rem] py-[4px]" onChange={(e)=>setLastName(e.target.value)}/>
                            <input type="text" placeholder={t('language.newsletter-email')} name="email" required className="shadow-md w-full sm:w-[16rem] bg-[#000000] opacity-30 pl-[1rem] py-[4px]" onChange={(e)=>setEmail(e.target.value)}/>
