...
const TestimonialCard = ({title, content})=>{
    ...
    return(
                <div className="testimonial flex flex-col self-center m-auto px-[2rem] md:px-[6rem] bg-white opacity-80 justify-center w-full max-w-[800px] h-[600px] rounded-xl">
                        {testimonials.map((testimonial, index)=>(
                        <div className="">
                            <div className={`content flex flex-col text-center items-center lg:h-[400px] ${index===currentIndex  ? 'block' : 'hidden'}`} >
                    ...
                    <div className="link flex self-end gap-[13px] items-center">
