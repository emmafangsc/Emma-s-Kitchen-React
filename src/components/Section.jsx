            ...
            <div className="section flex flex-col md:flex-row pb-24  md:gap-[7rem] justify-center">
                ...
                <div className="section__content md:w-[45rem]">
                    ...
                    <div className="button flex justify-end pt-8">
                        <button className={`bg-[#383838] shadow-ShadowBlack border-black border-[1px] text-yellow font-OrkneyBold ${styles.sectionButton} hover:text-[#383838] hover:bg-yellow`} >Learn more</button>
                    </div>
